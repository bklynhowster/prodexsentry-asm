...
# write_finding_history_for_scan_run + INSERT_FINDING_HISTORY_FOR_SCAN_RUN_SQL
# moved to scripts/scanner/finding_history_writer.py (4.7 H4, 2026-07-13) —
# shared across light/medium/heavy. Imported at the top of this module.
